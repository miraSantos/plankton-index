...
dfBv = read.csv('/vortexfs1/scratch/msantos/rac/data/biovol_concentration_by_class_time_series_CNN_daily08Sep2021.csv') #daily biovol concentration
dfConc = read.csv('/vortexfs1/scratch/msantos/rac/data/concentration_by_class_time_series_CNN_daily08Sep2021.csv') #daily biovol concentration
